...
User.create_with(username: 'xiaoming', password: '12345678', password_confirmation: '12345678', confirmed_at: DateTime.now).find_or_create_by!(:email => 'xiaoming@qq.com')
...
%w(数学研究机构 语文研究机构).each do |organization_name|
  Organization.create(name: organization_name, short_name: organization_name, intro: "#{organization_name}很好啊", desc: "#{organization_name}这个很长很长的描述",
                      city: "北京", address: '北京海淀区', contact_name:'张三', contact_mobile: '188888888')
end
